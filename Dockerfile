...
LABEL Ashraf Latif <hello@ceghap.com>
...
RUN set -ex; \
    ...
    zip \
    ; \
    pecl install imagick-3.4.4 memcached-3.1.5; \
...
# RUN wget https://github.com/php-memcached-dev/php-memcached/archive/v3.1.5.zip; unzip /usr/src/php/ext/memcached/v3.1.5.zip
# RUN mv /usr/src/php/ext/memcached/php-memcached-3.1.5/* /usr/src/php/ext/memcached/
